...
3. **DIAGNOSE** — find the dimension(s) dragging the mean and the *common cause* across cases. A score that's flat across rounds points at a structural gap, not a wording nit.
